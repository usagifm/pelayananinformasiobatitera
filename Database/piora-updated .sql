...
--
-- Host: localhost
-- Generation Time: May 03, 2020 at 07:50 PM
...
(33, 'Muhammad Nur Faqqih', 'wibu', '4ea7512f45a7cbff75b9492bea6150a8', 'usagifm@gmail.com'),
(46, 'asdasdawdawdawd', 'faqqih', '827ccb0eea8a706c4c34a16891f84e7b', 'pekontanjungjati1@gmail.com'),
(47, 'wibu mantap', 'wibu', 'e10adc3949ba59abbe56e057f20f883e', 'adawdawdawdawdawda'),
(48, 'orang biasa', 'orang', '827ccb0eea8a706c4c34a16891f84e7b', 'orangbiasa@gmail.com');
...
CREATE TABLE `obat` (
  ...
  `kontraindikasi_obat` text DEFAULT NULL,
  `bentuk` text NOT NULL,
  `reaksi_obatlain` text NOT NULL,
  `efek_samping` text DEFAULT NULL,
  `aturan_tambahan` text DEFAULT NULL,
  `golongan_obat` varchar(20) DEFAULT NULL,
  `create_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
...
INSERT INTO `obat` (`id_obat`, `id_admin`, `nama_generik`, `merek_dagang`, `indikasi_obat`, `kontraindikasi_obat`, `bentuk`, `reaksi_obatlain`, `efek_samping`, `aturan_tambahan`, `golongan_obat`, `create_at`, `deskripsi`) VALUES
(5, '1', 'parasetamol', 'sunmol', 'baik', NULL, 'pil', 'akan bracun jika dicampur ganja', NULL, NULL, NULL, '2019-05-03 03:42:09', 'obat pereda sakit '),
(6, '1', 'Amoxicillin', 'Amoksisilin, Amoxillin, Amoxsan, Arcamox, Kalmoxilin, Laprimox, Mokbios, Opimox, Pehamoxil, Solpenox, Widecillin', 'Obat ini dapat dikonsumsi dengan atau tanpa makanan. Untuk penyerapan yang lebih baik dan untuk mengurangi ketidaknyamanan saluran pencernaan, sebaiknya dikonsumsi dengan makanan.', 'Kontra Indikasinya', 'Tablet, bubuk, kapsul', 'akan tejadi Hipersensitivitas terhadap amoxicillin dan penisilin lainnya', 'Pusing pusing gais ', 'Jangan dimakan setelah makan racun , nanti mati bro', 'Obat Keras', '2020-04-06 14:59:07', 'Amoxicillin adalah antibiotik penisilin yang digunakan untuk mengobati berbagai macam infeksi bakteri. Obat ini juga digunakan bersama dengan obat lain seperti klaritromisin dan lansoprazole, untuk mengobati infeksi Helicobacter pylori dan ulkus duodenum yang ada pada saluran pencernaan.'),
(7, '1', 'Dopamine', 'Dopamin Giulini, Indop', 'Obat ini disuntikkan ke pembuluh darah melalui infus. Dosis diberikan sesuai kondisi medis. Pada saat penggunaan dopamine, perlu dilakukan pemantauan berkala terhadap tekanan darah, EKG, aliran urin, serta curah jantung. Beritahu dokter jika kondisi semakin memburuk atau tidak membaik.', NULL, 'Suntik', 'Risiko hipotensi dan bradikardi bila dikonsumsi bersamaan dengan fenitoin.', NULL, NULL, NULL, '2019-05-05 20:14:31', 'Dopamine merupakan obat yang digunakan untuk meningkatkan curah jantung dan tekanan darah selama resusitasi jantung paru. Dopamine juga dapat digunakan untuk tatalaksana denyut jantung lambat (bradikardia) yang disertai gejala, yang tidak respon dengan obat atropine.\r\nDopamine dengan obat dobutamine juga dapat berguna untuk  tatalaksana hipotensi (tekanan darah rendah)  pada pasien syok akibat serangan jantung, trauma, pembedahan, gagal jantung, gagal ginjal, dan kondisi lainnya.  Obat ini bekerja pada otot jantung sehingga dapat meningkatkan denyut jantung, kontraktilitas jantung yang pada akhirnya dapat meningkatkan curah jantung dan tekanan darah.\r\n'),
(8, '1', 'Viagra', 'Viagra hebat', 'asdawdawdawdawd', NULL, 'adawdawdawd', 'asadawd', NULL, NULL, NULL, '2020-03-04 14:50:24', 'sadadadas'),
(9, '1', 'Tramadol', 'hhkhhkhkhk', 'hfjhffjhjhjhfgjhgh', NULL, 'm,,m,.;ljljjlj;l', 'fjhjhggghgjhgjgjhfjhjhggghgjhgjgjhfjhjhggghgjhgjgjh', NULL, NULL, NULL, '2020-04-02 02:25:51', 'fjhjhggghgjhgjgjhfjhjhggghgjhgjgjhfjhjhggghgjhgjgjh'),
(10, '1', 'Paracetamol', 'SANMOL , PARAHSITAMOL', 'Tidak ada indikasi', 'Kontra indikasi obatnya', 'Tablet , Sirup dan Puyer', 'Reaksi tidak ada ', 'tidak ada reaksi lagi', 'Dikonsumsi setelah makan', 'Obat Bebas Terbatas', '2020-04-06 13:15:59', 'lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum \r\n\r\n\r\nlorem ipsum lorem ipsum '),
(14, '1', 'Arsenic', 'Arsenic Uhuy', 'tidak ada bos tidak ada bos tidak ada bos tidak ada bos tidak ada bos tidak ada bos tidak ada bos tidak ada bos tidak ada bos tidak ada bos ', 'tidak ada bos tidak ada bos tidak ada bos tidak ada bos tidak ada bos ', 'tidak ada bos tidak ada bos tidak ada bos tidak ada bos ', 'tidak ada bos tidak ada bos tidak ada bos ', 'tidak ada bos tidak ada bos tidak ada bos tidak ada bos ', 'tidak ada bos tidak ada bos tidak ada bos tidak ada bos tidak ada bos v', 'Obat Narkotika', '2020-04-08 19:28:39', 'tidak ada bos tidak ada bos tidak ada bos tidak ada bos tidak ada bos tidak ada bos ');
